                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-row">
                                            ...
                                            <label>Service Text</label>
                                                <input type="text" class="form-control" placeholder="Enter some text " name="text">
                                            </div>
...
if(isset($_POST['sub'])){
  ...
  $q="INSERT INTO `about`(`service_name`, `text`, `service_img`) VALUES ('$u','$p','$path')";
  $run=mysqli_query($con,$q);
  if($run){
    echo "<script>alert('Data has been entered');window.location.href='service_show.php'</script>";
  }
  else{
